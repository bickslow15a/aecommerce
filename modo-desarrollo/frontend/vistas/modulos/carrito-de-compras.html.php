			...
			<div class="panel-body cuerpoCarrito">
				...
				<div clas="row itemCarrito">
					...
					<div class="col-md-2 col-sm-1 col-xs-12">
						...
						<p class="precioCarritoCompra text-center">PEN S/.<span>10</span></p>
					...
					<div class="col-md-2 col-sm-1 col-xs-4 text-center">
						...
						<p>
							...
							<strong>PEN S/.<span>10</span></strong>
				...
				<div clas="row itemCarrito">
					...
					<div class="col-md-2 col-sm-1 col-xs-12">
						...
						<p class="precioCarritoCompra text-center">PEN S/.<span>11</span></p>
					...
					<div class="col-md-2 col-sm-1 col-xs-4 text-center">
						...
						<p>
							...
							<strong>PEN S/.<span>11</span></strong>
				...
				<div class="col-md-4 col-sm-6 col-xs-12 pull-right well">
					...
					<div class="col-xs-6">
						...
						<h4 class="sumaSubTotal">
							...
							<strong>PEN S/.<span>21</span></strong>
