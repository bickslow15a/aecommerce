            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                <?php
                    ...
                    $itemUsuario = "id";
                    $valorUsuario = $venta["id_administrador"];
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="hidden" name="idAdmin" value="<?php echo $vendedor["id"]; ?>">
                  ...
                  echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-6" style="padding-right:0px">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control nuevaDescripcionProducto" idProducto="'.$value["id"].'" name="agregarProducto" value="'.$value["titulo"].'" readonly required>
      ...
      <div class="col-lg-7 hidden-md hidden-sm hidden-xs">
        ...
        <div class="box box-warning">
          ...
          <div class="box-body">
            ...
            <table class="table table-bordered table-striped dt-responsive tablaVentasNormal">
